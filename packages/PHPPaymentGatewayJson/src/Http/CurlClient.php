...
use PaymentGatewayJson\Client\Http\Exception\ClientException;
...
class CurlClient implements ClientInterface
{
     ...
     * @throws \Exception
     */
    public function sign($apiId, $sharedSecret, $url, $body, $headers = [], $rfcCompliantTimezone = false, $newAlgo = false)
    {
    ...
    public function signJson($sharedSecret, $url, $body, $method, $rfcCompliantTimezone = false, $newAlgo = false)
    {
        ...
        $parts = [$method, $newAlgo ? hash('sha512', $body, false) : md5($body), $contentType, $timestamp, $requestUri];
