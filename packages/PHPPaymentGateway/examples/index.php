...
<form id="payment_form" method="POST" onsubmit="return selectedTransaction();">
    ...
    <div>
        ...
        <select name="TranType" id="TranType" onchange="loadRadio2()">
    ...
    <div id="IntegrationTypeCheckbox" style="display: inline;">
        ...
        <input type="radio" name="IntType" id="Redirect" value="Redirect" checked >Redirect to HPP<br>
    ...
    <div id="Initial" style="display: inline;">
        ...
        <select name="initialStoreTrans" id="initialStoreTrans" onchange="loadRadio2()">
    ...
    <div id="subSeqent" style="display: inline;">
        ...
        <select name="subSeqentTrans" id="subSeqentTrans" onchange="loadRadio2()">
            <option value="No" selected>No</option>
    ...
    <div id="schedul" style="display: none;">
        <input type="checkbox" id="gatewaySchadule" name="gatewaySchadule" checked>
        ...
        <select name="scheduleUnit" id="scheduleUnit">
            <option value="DAY" selected>DAY</option>
            <option value="WEEK">WEEK</option>
            <option value="MONTH">MONTH</option>
            <option value="YEAR">YEAR</option>
        </select><br>
        <label style="font-size: 16px">Schedule period:</label><input id="schedulePeriod" name="schedulePeriod"> Numbers only!<br>
        <label style="font-size: 16px">Schedule delay: Optional.</label><input id="scheduleDelay" name="scheduleDelay"> It can be used to set a differing length for the first period in format f.e.: '1 days 1 hour'. Min 24 hours<br>
        <br><br>
    </div>
    ...
    <div>
        <label >Email</label>
        <input type="text" id="email" name="email" value='test@email.com' />
    </div>
    <div>
