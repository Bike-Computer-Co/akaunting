...
return [
    ...
    'payment_due' => 'Dospeće plaćanja',
    'amount_due' => 'Dospeli iznos',
    'paid' => 'Plaćeno',
    'histories' => 'Istorija',
    'payments' => 'Uplate',
    'add_payment' => 'Dodaj plaćanje',
    'mark_paid' => 'Označeno plaćeno',
    'mark_received' => 'Označi kao primljeno',
    'mark_cancelled' => 'Označeno otkazano',
    'download_pdf' => 'Preuzmite PDF',
    'send_mail' => 'Pošaljite email',
    ...
    'messages' => [
        ...
        'status' => [
            'created' => 'Datum kreiranja :date',
            'receive' => [
                'draft' => 'Nije poslato',
                'received' => 'Datum prijema :date',
            ],
            'paid' => [
                'await' => 'Čekanje uplate',
            ],
        ],
    ],
