...
return [
    ...
    'recurring_bills'       => 'Повторлива сметка|Повторливи сметки',
    ...
    'form_description' => [
        'billing'           => 'Деталите за наплата се појавуваат во вашата сметка. Датумот на сметката се користи во контролната табла и извештаите. Изберете го датумот што очекувате да го платите како датум на доспевање.',
    ],
