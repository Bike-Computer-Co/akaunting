<x-layouts.admin>
    ...
    <x-slot name="buttons">
        ...
        <x-dropdown id="dropdown-new-actions">
            <x-slot name="trigger" class="flex items-center px-3 py-1.5 mb-3 sm:mb-0 bg-blue hover:bg-blue-700 rounded-xl text-white text-sm font-bold leading-6" override="class">
