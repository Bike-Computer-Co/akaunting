<x-layouts.preview>
    ...
    <x-slot name="buttons">
        ...
        <x-link href="{{ route('preview.payments.pdf', $payment->id) }}" class="bg-blue text-white px-3 py-1.5 mb-3 sm:mt-2 sm:mb-0 rounded-lg text-sm font-medium leading-6 hover:bg-blue-700">
