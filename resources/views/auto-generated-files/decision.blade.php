...
<p style="text-indent: 45px;">
    ...
    производство, трговија и услуги {{$firm_name}} ДООЕЛ {{$municipality}} содружникот {{$name}} од {{$municipality}}, {{$address}} со ЕМБГ {{$embg}}, државјанин на
...
<p style="text-indent: 45px;">За управител на друштвото со ограничена одговорност се
    именува {{$name}} од {{$municipality}}, {{$address}} со ЕМБГ {{$embg}} државјанин на Р.С.Македонија , со неограничени овластувања во застапувањето
