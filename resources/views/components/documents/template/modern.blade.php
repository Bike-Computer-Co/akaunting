                        ...
                        <thead style="background-color:{{ $backgroundColor }} !important; -webkit-print-color-adjust: exact;">
                            <tr>
                                ...
                                @stack('quantity_th_start')
                                    @if (! $hideQuantity)
                                        <th class="quantity text text-bold text-white text-alignment-right text-right">
                                            {{ trans($textQuantity) }}
                                        </th>
                                    @endif
                                ...
                                @stack('price_th_start')
                                    @if (! $hidePrice)
                                        <th class="price text text-bold text-white text-alignment-right text-right">
                                            {{ trans($textPrice) }}
                                        </th>
                                    @endif
                                @stack('price_th_end')
                                ...
                                @if (! $hideDiscount)
                                    @if (in_array(setting('localisation.discount_location', 'total'), ['item', 'both']))
                                        @stack('discount_td_start')
                                            <th class="discount text text-bold text-white text-alignment-right text-right">
