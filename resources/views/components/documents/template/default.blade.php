    ...
    <div class="row top-spacing">
        <div class="col-60">
            <div class="text p-index-left">
                @if (! $hideContactInfo)
                    <p class="text-bold mb-0">{{ trans($textContactInfo) }}</p>
                @endif
                    ...
                    <table class="lines">
                        ...
                        <tr>
                            ...
                            @if (! $hideItems || (! $hideName && ! $hideDescription))
                                <th class="item text text-bold text-alignment-left text-left text-white border-radius-first">
                            ...
                            @if (! $hideQuantity)
                                <th class="quantity text text-bold text-alignment-right text-right text-white">
                                    {{ trans($textQuantity) }}
                                </th>
                            @endif
                            ...
                            @if (! $hidePrice)
                                <th class="price text text-bold text-alignment-right text-right text-white">
                                    {{ trans($textPrice) }}
                                </th>
                            @endif
                            @stack('price_th_end')
                            ...
                            @if (! $hideDiscount)
                                @if (in_array(setting('localisation.discount_location', 'total'), ['item', 'both']))
                                    ...
                                    <th class="discount text text-bold text-alignment-right text-right text-white">
                            ...
                            @if (! $hideAmount)
                                <th class="total text text-bold text-white text-alignment-right text-right border-radius-last">
                                    {{ trans($textAmount) }}
                                </th>
                            @endif
                            @stack('total_th_end')
