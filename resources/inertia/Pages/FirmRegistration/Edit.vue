    ...
    <div>
        ...
        <form class="row" @submit.prevent="submit">
            <div class="col col-12 col-md-6">
                ...
                <div class="mb-3">
                    <label for="founder_id_number" class="form-label"
                    >Бр. на лична карта на основач</label
                    >
                    <input
            ...
            <div class="text-center">
                <button type="submit" class="btn btn-primary px-3">Измени</button>
            </div>
        </form>
    </div>
</template>
...
export default {
    ...
    methods: {
        submit() {
            this.form.put(this.$route("super.firm-registrations.update", this.firmRegistration.id), {
                onSuccess: () => {
                    form.reset();
                },
            });
    ...
    data() {
        return {
            form: this.$inertia.form({
                form_of_firm: this.firmRegistration.form_of_firm,
                firm_name: this.firmRegistration.firm_name,
                founder_name: this.firmRegistration.founder_name,
                founder_address: this.firmRegistration.founder_address,
                founder_embg: this.firmRegistration.founder_embg,
                founder_id_number: this.firmRegistration.founder_id_number,
                manager_name: this.firmRegistration.manager_name,
                manager_address: this.firmRegistration.manager_address,
                manager_embg: this.firmRegistration.manager_embg,
                headquarters_address: this.firmRegistration.headquarters_address,
                headquarters_municipality_id:
                this.firmRegistration.headquarters_municipality_id,
                headquarters_settlement_id:
                this.firmRegistration.headquarters_settlement_id,
                subsidiary_address: this.firmRegistration.subsidiary_address,
                subsidiary_municipality_id:
                this.firmRegistration.subsidiary_municipality_id,
                subsidiary_settlement_id: this.firmRegistration.subsidiary_settlement_id,
                occupation_code: this.firmRegistration.occupation_code,
                stake_duration: this.firmRegistration.stake_duration,
                stake_type: this.firmRegistration.stake_type,
                bank_id: this.firmRegistration.bank_id,
                phone: this.firmRegistration.phone,
                email: this.firmRegistration.email,
                stamp_address: this.firmRegistration.stamp_address,
                stamp_type: this.firmRegistration.stamp_type,
            }),
            DOO,
            TP,
            IMMEDIATELY,
